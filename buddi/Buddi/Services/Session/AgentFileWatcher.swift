...
private let logger = os.Logger(subsystem: "com.splab.buddi", category: "AgentFileWatcher")
...
class AgentFileWatcher {
    ...
    private let queue = DispatchQueue(label: "com.buddi.agentfilewatcher", qos: .userInitiated)
